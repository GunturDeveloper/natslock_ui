  ...
  <div class="bg-gray-900 p-6 rounded-lg shadow-md">
    ...
    <div v-if="lockerData">
      <div class="flex justify-between items-center mb-2">
        ...
        <div
          :class="{
            'bg-red-500': lockerData.PilotLamp_Red === 'On',
            'bg-green-500': lockerData.PilotLamp_Red === 'Off'
          }"
...
export default {
  ...
  methods: {
    async fetchLockerData() {
      try {
        const response = await axios.get('http://192.168.183.4:2045/api/systemdb/all')
